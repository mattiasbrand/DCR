...
namespace Client
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var factory = new DuplexChannelFactory<Server.IDynamicContract>(site, new NetNamedPipeBinding { OpenTimeout = TimeSpan.FromSeconds(10), MaxBufferSize = 2147483647, MaxReceivedMessageSize = 2147483647 }, new EndpointAddress(endpointAddress));
    ...
    internal class Callback : IDynamicCallBack
    {
